...
Text(0.5, 1.0, 'Table 1.1: A bar graph showing the relationship of chosen track in college .')
...
Text(0.5, 1.0, 'Table 1.2: A bar graph showing the relationship of gender and average grade.')

#Function to print the graph that states the correlation of to grades.
plt.figure(figsize=(5,6))
...
plt.ylabel ("Average")
plt.title ("Table 1.3: A bar graph showing the relationship of hometown and average grade.")
Text(0.5, 1.0, 'Table 1.3: A bar graph showing the relationship of hometown and average grade.')
```
